...
#修改主机名
sed -i 's/OpenWrt/xiaomi-nrv3/g' package/base-files/files/bin/config_generate
#修改型号显示
...
#设置WIFI
sed -i 's/OpenWrt/xiaomi_nrv3/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
...
sed -i '/encryption/a\set wireless.default_radio${devidx}.key=yy992266' package/kernel/mac80211/files/lib/wifi/mac80211.sh
#修改登录密码为coolxiaomi
